...
public class AddPropertyCommandParser implements Parser<AddPropertyCommand> {
        public static final String POSTAL_MISSING = "Postal parameter (" + PREFIX_PROPERTY_POSTAL
                        + "POSTAL) is missing.\n";
        ...
        public static final String STATUS_MISSING = "Status parameter (" + PREFIX_PROPERTY_STATUS
                        + "STATUS) is missing.\n";
